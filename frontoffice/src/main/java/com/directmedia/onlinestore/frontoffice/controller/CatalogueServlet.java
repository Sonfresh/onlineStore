        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.print("<h1 style='text-align: center; margin-top:100px;'> Catalogues </h1>");
             ...
             for (Work work : Catalogue.listOfWorks) {
                out.print("<div style='width:33%; float:left; text-align:center; background:#efefef; padding:40px 0px; margin:2px;' >");

                out.print("<img src='"+work.getUrlImg()+"' style='width:300px; height:200px;'/>");

                out.print("<p> <a href='http://localhost:8080/frontoffice-1.0/work-details?id=" + work.getId() +"'>" + work.getTitle() + "</a></p>");
